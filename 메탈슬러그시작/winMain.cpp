...
//==============================================================//
HWND		_hWnd;					// 핸들 윈도우
HINSTANCE	_hInstance;				// 핸들 인스턴스
POINT		_ptMouse = { 0, 0 };	// 마우스 좌표값(X,Y)
...
//==============================================================//
	...
	/*
	//게임용 나중에 사용한다 (사용자가 정보를 주지 않아도 내부 정보를 계속해서 실행한다.)
	while (true)
	{
	...
	*/
	...
	//일반 프로그래밍용 (사용자가 정보를 주지 않는한 아무런 동작도 하지 않는다.)
